...
\begin{frame}[shrink]{Variables in Our Study}
...
\begin{frame}[shrink]{When Linear Regression Fails}
...
\begin{frame}[shrink]{Interpreting Coefficients: Log-Odds vs. Odds Ratios}
...
\begin{frame}[shrink]{Model Fit and Diagnostics}
...
\begin{frame}[shrink]{Lifestyle-Physiology Relationship: Setup}
